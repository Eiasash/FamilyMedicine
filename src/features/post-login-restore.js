 ...
 *   cloud backup row (`mishpacha_backups` keyed on `user_<username>`) has
 ...
 *        device (suppress marker `mishpacha.restore-prompted.<username>`).
...
const SUPPRESS_KEY_PREFIX = 'mishpacha.restore-prompted.';
