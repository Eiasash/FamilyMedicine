...
export const BUILD_HASH='1061q-v1.21.25';
export const SYLLABUS_VERSION='P0062-2025';
export const CHANGELOG={
  '1.21.25': [
    '📚 Citation backfill batch 4 — 19 ti=18 (Mental Health) explanations gain a verified Goroll 8e Section XV (Psychiatric and Behavioral Problems) source citation. Each Q\'s chapter mapping was anchor-verified against locally extracted Goroll 8e PDF text BEFORE the citation was appended (per release-invariant §4); ≥2 distinct anchor hits required, all 19 cleared the threshold cleanly. Chapter distribution: 11 cite פרק 227 (Approach to the Patient with Depression, pp 5397-5459) — covers PHQ-9/PHQ-2 screening, suicide prevention + safety planning, lithium monitoring (renal + thyroid + thiazide/NSAID interactions), bipolar pharmacotherapy, SSRI cardiovascular profile + sexual dysfunction, duloxetine for depression+neuropathy, adjustment disorder with depressed mood; 3 cite פרק 226 (Approach to the Patient with Anxiety, pp 5354-5396) — adjustment disorder with anxiety/situational, panic disorder, PTSD; 2 cite פרק 233 (Approach to Eating Disorders, pp 5602-5635) — anorexia workup + hospitalization criteria; 2 cite פרק 232 (Approach to the Patient with Insomnia, pp 5565-5601) — delayed sleep phase + CBT-I stimulus control; 1 cites פרק 230 (Approach to the Patient with Somatic Symptom Disorder, pp 5536-5554) — factitious disorder (insulin self-injection). Format follows the existing v1.21.x Goroll citation form (`מקור: Goroll 8e פרק N.`). Append-only on q.e — no q.c, q.o, or pre-existing q.e content modified. Scope notes: 32 ti=18 uncited Qs total. 13 deferred to a future Lerner 2025 batch — 1 dropped (pos=54 chronic fatigue syndrome — outside Section XV; CFS belongs in earlier Goroll non-psych chapter), 7 are Israeli psychiatric-law specific (involuntary admission per חוק טיפול בחולי נפש, ועדת בדיקה כפויה — Goroll doesn\'t cover Israeli law), and 5 are FM-Core IPV/abuse Qs that rely on Israeli child-protection + elder-abuse mandatory reporting (חוק הזקן, חוק הנוער 368ד) — Lerner חוק ואתיקה chapter is the right cite for those. tests/citationCoveragePilot.test.js extended with MENTAL_HEALTH_BATCH (per-pos pin) + cumulative floor bumped 75 → 94. Cumulative campaign progress: 16 (HTN/Lipid v1.21.22) + 27 (DM v1.21.23) + 32 (ti=26 EBM/law/family v1.21.24) + 19 (ti=18 Mental Health v1.21.25) = 94 of ~957 uncited Qs verified-cited (9.8% of remaining gap).',
  ],
  '1.21.24': [
