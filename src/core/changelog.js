...
export const CHANGELOG={
  '1.26.5': [
    'content(highyield): +40 AI high-yield board MCQs into the additive data/highyield.json bank (168 to 208, tag AI-2026-hy) — same separate-bank design, so data/questions.json count-lock (1121) + BUILD_HASH count + cross-repo contract stay untouched. Generated FRESH this batch by 5 Opus subagents (Toranot proxy secret unavailable this session) writing ORIGINAL clinical vignettes across FM domains, each explicitly warned off the ambiguity traps the prior pilot exposed (HFrEF ARNI-vs-MRA, diabetic-CKD RAS-vs-SGLT2, gout NSAID-vs-steroid, the outdated 2013 USPSTF lung-CT criteria). Gate: structural validation (0 fails) + dedup vs the live 168+1121 banks (0 duplicates) + a 3x-Opus BLIND audit (each picking the answer WITHOUT the key) = 100% blind agreement, 0 ambiguity flags — markedly cleaner than the pilot (81% / 38% flags) because the generators built single-best-answer vignettes (e.g. patient already on a RAS-blocker so SGLT2i is unambiguous; CKD4+PUD so steroid is the only safe gout option; current 50-80/≥20py lung criteria). ti tags re-derived by content against the 27-topic map. Audit doc: docs/AUDIT_HY_BATCH2_2026-06-11.md. No data/questions.json edits. BUILD_HASH 1121q-v1.26.5; 1.26.4 to 1.26.5.'
  ],
  '1.26.4': [
