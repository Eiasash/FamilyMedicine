...
try{G.sdLeaderboard=JSON.parse(localStorage.getItem('mishpacha_sd_lb')||'[]')}catch(e){}
// Quiz modes & peripherals — extracted from mishpacha-mega.html
...
localStorage.setItem('mishpacha_sd_lb',JSON.stringify(G.sdLeaderboard));
G.sdMode=false;
