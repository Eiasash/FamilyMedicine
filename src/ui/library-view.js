...
const SYL_HAZ=[];
// Harrison chapters trimmed for P0062-2025 family-medicine scope (v1.2.9).
// Goroll 8e is the primary textbook — Harrison is cross-reference only.
// Dropped 27 ICU/inpatient/specialist chapters (shock, sepsis, oncologic emergencies,
// vasculitis, GBS/MG, ICH, encephalitis, IE, osteomyelitis, etc.) — Goroll covers
// what FM needs at the outpatient level. 42 chapters remain.
const SYL_HAR_ALL=[
...
{ch:20,t:'Fever'},{ch:39,t:'Dyspnea'},
{ch:40,t:'Cough'},{ch:43,t:'Edema'},
