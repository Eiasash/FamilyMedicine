...
// ===== Track progress donut (parity with Pnimit/Shlav, v1.26.6) =====
// The one stats visual the Track tab lacked (per AGENTS.md). Computes
// correct / wrong / טרם-נענה straight from the FSRS spaced-rep store
// (G.S.sr) and the loaded question array (G.QZ). Two distinct accuracies:
// question-status (is the card currently "known", n>0) and historical
// attempt accuracy (ok/tot across all graded attempts). Does NOT duplicate
...
// Progress donut — single-glance correct/wrong/unanswered summary (v1.26.6)
