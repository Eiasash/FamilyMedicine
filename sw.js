const CACHE='mishpacha-v1.25.11';
...
const JSON_DATA_URLS=['data/questions.json','data/topics.json','data/notes.json','data/tabs.json','data/distractors.json','data/nelson_notes.json','data/ai_hard_seed.json','goroll_chapters.json','harrison_chapters.json','nelson_chapters.json','lerner_chapters.json'];
