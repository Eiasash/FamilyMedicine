/**
 * Guards the v1.26.2 #353 fix (sibling of Geri v10.64.160 / Pnimit v10.4.45):
 * API-key account sync at save time.
 *
 * Background: the v1.26.1 security fix removed _apikey from the cloud backup
 ...
 * rotated after .1 stayed localStorage-only and auth_login_user restored a
 * stale/null key on the next device (Codex P2 on #142).
 *
...
describe('#353 — API-key account sync (FM port)', () => {
  ...
  it('v1.26.1 regression locks stay intact (no _apikey back in the backup payload)', () => {
