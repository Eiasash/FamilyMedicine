...
# Generate for Mishpacha
node scripts/generate-questions.cjs --app mishpacha --all --count 10 --api-key sk-ant-...
...
| Flag | Description |
|------|-------------|
| `--app` | `geriatrics` or `mishpacha` (required) |
...
**Mishpacha**: 69 Harrison chapters

At 10q per chapter: ~1,240 new geriatrics questions, ~690 new mishpacha questions.
