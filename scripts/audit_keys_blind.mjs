...
const EXAMINER =
  'a board-certified family physician serving as an independent answer-key auditor for an Israeli family-medicine board exam (Shlav Alef). Use current board-level evidence: Goroll 8e, AFP/USPSTF/CDC, Israeli MOH guidance, and major society guidelines';
